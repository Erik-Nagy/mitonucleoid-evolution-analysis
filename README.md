...
| 05* | Disorder score — pSTY vs all S/T/Y background |
| 06 | Exposed vs buried P-sites (bar chart) |
| 07 | Surface exposure by residue type |
| 08* | Surface exposure — pSTY vs all S/T/Y background |
| 09 | AlphaFold2 pLDDT scores (histogram with confidence zones) |
| 10 | pLDDT score by residue type |
| 11* | pLDDT — pSTY vs all S/T/Y background |
| 12 | Conservation in ordered vs disordered P-sites |
| 13 | Conservation vs surface exposure |
| 14 | Disorder score vs surface exposure |
