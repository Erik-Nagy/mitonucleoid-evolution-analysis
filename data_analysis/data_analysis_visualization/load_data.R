...
psite_long <- read_tsv(psite_long_path, show_col_types = FALSE,
  ...
  rename(
    ...
    functional_cons  = `P-site Functional Conservation (%)`,
    plddt            = `P-site AF2 pLDDT Score`,
    structural_state = `P-site AF2 Structural State`,
  ...
  mutate(
    ...
    functional_cons  = as.numeric(functional_cons),
